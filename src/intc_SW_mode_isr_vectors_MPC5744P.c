...
(uint32_t) &PIT0_CH1_ISR, /* Vector # 227 Periodic Interrupt Timer (PIT_0) channel 1 PIT_0 */
...
(uint32_t) &SPI_REC_ISR, /* Vector # 263 DSPI_SR[RFDF] DSPI0 */
...
(uint32_t) &UART0_ISR, /* Vector # 376 LINFlex_RXI LINFlex_0 */
...
(uint32_t) &UART1_ISR, /* Vector # 380 LINFlex_RXI LINFlex_1 */
...
(uint32_t) &CAN0_Rec_ISR, /* Vector # 522 FLEXCAN_BUF_00_03 FlexCAN_0 */
